...
audio_dir=/workspaces/adapted-hi-asr-model/iitm-asr-toolkit/audio   #complete path to the folder with all wav audio files; should be organised in train, dev, eval subfolders
...
echo ============================================================================           
	...
	for x in $train_set $recog_sets; do
		python2 steps/data/generate_wav_scp.py \
